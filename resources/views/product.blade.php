...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="{{ asset('public/img/' . $product->image) }}" alt="product" class="img-responsive">
            </div>
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <div class="caption text-center">
                            <a href="{{ url('shop', [$product->slug]) }}"><img src="{{ asset('public/img/' . $product->image) }}" alt="product" class="img-responsive"></a>
